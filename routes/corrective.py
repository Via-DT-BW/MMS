...
def corrective_analytics():
    ...
    try:
        ...
        return render_template('corrective/analytics.html', maintenance="Manutenção", records=data, page=page, total_pages=total_pages, filter_prod_line=filter_prod_line, start_date=start_date, end_date=end_date)

    except Exception as e:
        print(e)
        flash(f'Ocorreu um erro: {str(e)}', category='error')
        return render_template('corrective/analytics.html', maintenance="Manutenção", records=[])
